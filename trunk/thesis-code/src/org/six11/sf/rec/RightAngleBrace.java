...
public class RightAngleBrace extends RecognizedItemTemplate {
  ...
  public RightAngleBrace(SketchBook model) {
    ...
    addConstraint(new Coincident(model, "c1", "line1.p2", "line2.p1"));
    addConstraint(new EqualLength(model, "c2", "line1", "line2"));
    addConstraint(new AngleConstraint(model, "c3", new Interval(toRadians(82), toRadians(98)),
        new Interval(toRadians(70), toRadians(110)), "line1", "line2"));
    addConstraint(new LineLengthConstraint(model, "c4", yesInterval, maybeInterval, "line1"));
    addConstraint(new LineLengthConstraint(model, "c5", yesInterval, maybeInterval, "line2"));
  }
